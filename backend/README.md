...
## Project Structure
    ...
    ├── cannaquikdeliveries_36380  # Django project configurations
...
1. Clone this repo and `cd cannaquikdeliveries_36380`
...
2. Clone this repo and `cd cannaquikdeliveries_36380`
